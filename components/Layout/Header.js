...
// cvv
//             {/* <ul className='hidden lg:flex col-start-3 col-end-8 text-black-700 font-medium items-center text-lg space-x-4'> */}
...
//     smooth={true}
//     duration={1000}
//     onSetActive={() => setActiveLink('servicepartner')}
//     className={
//       'px-3 py-2 mx-2 cursor-pointer animation-hover inline-flex items-center whitespace-nowrap align-middle text-lg font-medium transition-all duration-300 ' +
//       (activeLink === 'servicepartner'
//         ? 'text-orange-250 animation-active border-b-2 border-orange-250'
//         : 'text-black-500 hover:text-orange-250')
//     }
//   >
//     {t('ourServicePartner')}
...
//                 <button
//   type='button'
//   className='inline-flex justify-center items-center whitespace-nowrap px-3 py-2 text-base font-semibold bg-gray-800 hover:bg-gray-700 focus:outline-none focus:bg-gray-700'
// >
//   {t('mob_head.s9')}
//   <svg
//     className='w-4 h-4 ml-2 -mr-1'
...
//                   <div className='py-1'>
//                     <Link href='/automotive-metal-works'>
//                       <a className='block px-4 py-2 text-sm text-gray-700 hover:bg-orange-250 hover:text-white-500'>
//                         {' '}
//                         {t('mob_head.s10')}
//                       </a>
//                     </Link>
//                     <Link href='/refrigerated-truck-bodies'>
//                       <a className='block px-4 py-2 text-sm text-gray-700 hover:bg-orange-250 hover:text-white-500'>
//                         {t('mob_head.s11')}
//                       </a>
//                     </Link>
//                     <Link href='/trailers-special-bodies'>
//                       <a className='block px-4 py-2 text-sm text-gray-700 hover:bg-orange-250 hover:text-white-500'>
//                         {t('mob_head.s12')}
//                       </a>
//                     </Link>
//                     <Link href='/tail-lifts-Conversions'>
//                       <a className='block px-4 py-2 text-sm text-gray-700 hover:bg-orange-250 hover:text-white-500'>
//                         {t('mob_head.s13')}
//                       </a>
//                     </Link>
...
//                   <span className='absolute md:-top-3 md:-right-3 -top-2 -right-2 flex md:h-6 md:w-6 w-5 h-5 items-center justify-center'>
//                     <span className='absolute top-0 left-0 h-full w-full rounded-full bg-green-500 opacity-75 animate-ping'></span>
