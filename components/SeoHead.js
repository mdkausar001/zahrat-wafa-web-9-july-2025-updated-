...
const defaultMeta = {
  title: 'Zahrat Al Wafa',
  siteName: 'Zahrat Al Wafa',
  description:
    'Zahrat Al Wafa Your trusted partner to perform any car service or repairs.',
  // change base url of your web (without '/' at the end)
  url: 'https://zahrat-wafa.com/',
  type: 'website',
  robots: 'follow, index',
  // change with url of your image (recommended dimension = 1.91:1)
  // used in twitter, facebook, etc. card when link copied in tweet/status 
  image: Logo,
  author: 'Mohammad Sharib kausar'
};
